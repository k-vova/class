const PAGES = [
    ...
    },
    {
        ...
        name: "Відео YouTube",
        youtubeVideos: [
            { id: "9uBKizur3ZM", caption: "Ульянівська середня школа №2" },
        ],
    },
];
...
// =======================================================
// ===== ВИПРАВЛЕННЯ ДЛЯ ВІДЕО В ГАЛЕРЕЇ (START) =====
// =======================================================
function renderPage(pageId) {
    ...
    if (page.id === "youtube-videos") {
        ...
        if (page.photos) {
            ...
            // Огортаємо кожне відео в таку ж рамку, як і фото
...
// =====================================================
// ===== ВИПРАВЛЕННЯ ДЛЯ ВІДЕО В ГАЛЕРЕЇ (END) =====
// =====================================================
